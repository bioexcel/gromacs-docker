...
COPY --from=longr/gromacs-docker-container-maker:gmx-2020.2-cuda-10.2-AVX_512
COPY --from=longr/gromacs-docker-container-maker:gmx-2020.2-cuda-10.2-AVX_256
COPY --from=longr/gromacs-docker-container-maker:gmx-2020.2-cuda-10.2-AVX2_256
COPY --from=longr/gromacs-docker-container-maker:gmx-2020.2-cuda-10.2-SSE2
